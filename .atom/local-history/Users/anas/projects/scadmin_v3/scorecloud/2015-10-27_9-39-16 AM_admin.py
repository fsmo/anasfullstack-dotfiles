...
def get_song_counters_link(song):
    return '<a target="_blank" href="%s%s">%s</a>' % ('/admin/scorecloud/objectcounter/?q=',song.song_id, 'Get Song\'s counters')
...
class SongsAdmin(BaseModelAdmin):
    ...
    list_filter = ('popularity','maturity','source_type', 'is_active', 'is_shared', 'is_public', 'is_deleted', PermissionsFilter,
...
admin.site.register(ObjectCounter, ObjectCounterAdmin)
