App.service('webRecorderService', [function(){
  ...
  this.startStreaming = function() {
    ...
    //     self.bigBuffer.push(buffers[0]);
    //
    //     console.log(buffers[0]);
    //     Meteor.subscribe('stream', buffers[0]);
    //   });
    //
    //   self.audioRecorder.clear();
    //   console.log(self.bigBuffer);
    // }, 1000);
    setInterval(function() {
      self.audioRecorder.exportWAV(function(blob) {
        self.bigBuffer.push(blob);
      ...
      self.audioRecorder.clear();
    //x  console.log(self.bigBuffer);
    }, 3000);
  };

  this.stopStreaming = function(){
    var finalBuffer = _.flatten(self.bigBuffer);
    console.log(finalBuffer);
    self.audioRecorder.stop();
    var canvas = document.getElementById( 'wavedisplay' );
    self.drawBuffer( canvas.width, canvas.height, canvas.getContext('2d'), finalBuffer );
