    ...
    it('Should Create a new user with a know password and resetPasswordToken', function(done) {
      request(sails.hooks.http.app)
        ...
        .send({
          ...
          "email": "anas.ieee@gmail.com",
          "password": "$2a$10$RB1JBX56d67oPeGK7rSOOOLkTijKtBT1qdfvD.evWk7qBXPWl2Hym",
          "emailVerified": false,
          "isDeleted": false,
          "createdAt": ISODate("2015-12-10T10:26:35.857Z"),
          "updatedAt": ISODate("2015-12-10T10:26:36.407Z"),
          "id": NaN,
          "name": "newName",
          "location": "USA",
          "resetPasswordToken": "5f09dd037a4284aacda48fea802d30b0e78e5299",
          "resetPasswordExpires": ISODate("2015-12-10T10:26:36.000Z")
        })
    });
    it('Should update user wit a new password given newPassword and a valid token', function(done) {
