  ...
  forgotPassword: function(req, res, next) {
    ...
    async.waterfall([
      ...
      function(token, user, done) {
        ...
        // var transporter = nodemailer.createTransport(smtpTransport({auth: sendGridAuth}));
        // var mailOptions = {
        //   to: user.email,
        ...
        sendgrid.send({
          ...
          from: 'passwordreset@sharkfish.com',
          subject: 'sharkfish Password Reset',
          text: text: 'You are receiving this because you (or someone else) have requested the reset of the ' +
            'password for your account.\n\n' +
            'Please click on the following link, or paste this into your browser to complete the process:\n\n' +
            'http://' + req.headers.host + '/reset/' + token + '\n\n' +
            'If you did not request this, please ignore this email and your password will remain unchanged.\n'
