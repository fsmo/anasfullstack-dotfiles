...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      js: {
        files: ['<%= yeoman.app %>/modules/*/*.js', '<%= yeoman.app %>/modules/*/config/*.js', '<%= yeoman.app %>/modules/*/controllers/*.js', '<%= yeoman.app %>/modules/*/services/*.js', '<%= yeoman.app %>/modules/*/directives/*.js', '<%= yeoman.app %>/modules/*/filters/*.js', '<%= yeoman.app %>/modules/*/lib/*.js','<%= yeoman.app %>/**/**/**/**/*'],
      ...
      styles: {
        files: ['<%= yeoman.app %>/css/**/*.css', '<%= yeoman.app %>/modules/*/css/*.less'],
