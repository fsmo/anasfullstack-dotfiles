...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      js: {
        files: ['<%= yeoman.app %>/modules/*/*.js', '<%= yeoman.app %>/modules/*/config/*.js', '<%= yeoman.app %>/modules/*/controllers/*.js', '<%= yeoman.app %>/modules/*/services/*.js', '<%= yeoman.app %>/modules/*/directives/*.js', '<%= yeoman.app %>/modules/*/filters/*.js', '<%= yeoman.app %>/modules/*/lib/*.js'],
      ...
      styles: {
        files: ['<%= yeoman.app %>/css/**/*.css', '<%= yeoman.app %>/css/**/*.less'],
    ...
    less: {
        options: {
          paths: ['<%= yeoman.app %>/modules/*/css/*.less', '<%= yeoman.app %>/css/*.less']
        },
        files: {
          '<%= yeoman.app %>/css/style_less.css': '<%= yeoman.app %>/css/style_less.less'
        }
    },
      ...
      dist: {
        files: {
          src: [
            ...
            '<%= yeoman.dist %>/app/modules/*/lib/*.js',
            '<%= yeoman.dist %>/app/modules/*/css/*.css',
            '<%= yeoman.dist %>/app/modules/*/css/*.less',
            '<%= yeoman.dist %>/app/css/**/*.css',
            '<%= yeoman.dist %>/app/css/**/*.less',
