  ...
  loadCredentials(function(err, credentials) {
    ...
    orm.init(function() {
      ...
      var updateTopTagsMatView = createCronJob(cronTimes.a, function() {
        ...
        orm.getModel('materialized_top_tags_view').query('REFRESH MATERIALIZED VIEW materialized_top_tags_view;',
          function() {
      ...
      var addGaveUpUsers = createCronJob(cronTimes.c, function() {
        ...
        ML.addGaveUpUsersToQueue().then(function(){ addGaveUpUsers.stop(); });
      }, function() {
        log.info('updateSongMatView', stopped);
      });
      ...
      var addNoNewSongsUsers = createCronJob(cronTimes.d, function() {
        ...
        ML.addNoNewSongsUsersToQueue().then(function(){ addNoNewSongsUsers.stop(); });
      }, function() {
      ...
      var addNoSongsUsers = createCronJob(cronTimes.e, function() {
        ...
        ML.addNoSongsUsersToQueue().then(function(){ addNoSongsUsers.stop(); });
      }, function() {
      ...
      var addNewUsersMainList = createCronJob(cronTimes.g1, function() {
        log.info('addNewUsersMainList', running);
        ML.addNewUsersToRegistrationLists(1, ML.mailingListsNames.mainList).then(function(){ addNewUsersMainList.stop(); });
      }, function() {
      ...
      var addNewUsersToStudioList = createCronJob(cronTimes.g2, function() {
        ...
        ML.addNewUsersToRegistrationLists(2, ML.mailingListsNames.studioList).then(function(){ addNewUsersMainList.stop(); });
      }, function() {
        log.info('addNewUsersMainList', stopped);
      });
      ...
      var addNewUsersToRegistration = createCronJob(cronTimes.g3, function() {
        ...
        ML.addNewUsersToRegistrationLists(3, ML.mailingListsNames.expressList);.then(function(){ addNewUsersMainList.stop(); });
      }, function() {
        log.info('addNewUsersMainList', stopped);
      });
      ...
      var addNewUsersToOthersList = createCronJob(cronTimes.g4, function() {
        ...
        ML.addNewUsersToRegistrationLists(4, ML.mailingListsNames.mainList).then(function(){ addNewUsersMainList.stop(); });
      }, function() {
        log.info('addNewUsersMainList', stopped);
      });
