...
(function initCron(handler) {
  ...
  loadCredentials(function(err, credentials) {
    ...
    orm.init(function() {
      ...
      //updateSongMaterialView cron job runs daily at 04:30
      ...
      var addNoSongsUsers = createCronJob('00 21 13 * * *',function() {
      ...
      var addUsersToMailingList = createCronJob('00 37 13 * * *',function() {
