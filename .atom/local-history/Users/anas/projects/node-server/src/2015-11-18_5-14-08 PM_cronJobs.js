...
(function initCron(handler) {
  ...
  loadCredentials(function(err, credentials) {
    ...
    orm.init(function() {
      ...
      //updateSongMatView cron job runs daily at 04:15
      var updateSongMatView = createCronJob('00 15 04 * * *',function() {
        log.info('updateSongMatView cron job started at 04:15 is now runnning!!');
