...
(function initCron(handler) {
  ...
  loadCredentials(function(err, credentials) {
    ...
    schedule.scheduleJob(cronTimes.g30,
      ...
      schedule.scheduleJob(cronTimes.g45,
        function() {
      ...
      schedule.scheduleJob(cronTimes.h00,
        function() {
      ...
      schedule.scheduleJob(cronTimes.i00,
        function() {
      ...
      schedule.scheduleJob(cronTimes.i30,
        function() {
      ...
      schedule.scheduleJob(cronTimes.j00,
        function() {
      ...
      schedule.scheduleJob(cronTimes.j15, function() {
