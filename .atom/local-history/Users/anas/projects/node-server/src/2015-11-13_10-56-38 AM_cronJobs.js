...
(function initCron(handler) {
  ...
  loadCredentials(function(err, credentials) {
    ...
    orm.init(function() {
      ...
      // addGaveUpUsers cron job started runs daily at 05:00
      ...
      // addNoNewSongsUsers cron job started runs daily at 05:30
      ...
      // addNoSongsUsers cron job started runs daily at 06:00
      ...
      // cron job started runs daily at 06:30
      ...
      // addNewUsersToRegistration cron job started runs daily at 07:00
      ...
      // addUsersToMailingList cron job started runs daily at 08:00
      ...
      // createProfileIndexes cron job started runs daily at 09:00
      ...
      // createSongsIndexes cron job started runs daily at 09:30
      ...
      // createSitemapsIndex cron job started runs daily at 10:00
      ...
      //uploadSiteMaps cron job started runs daily at 10:15
