  ...
  loadCredentials(function(err, credentials) {
    ...
    orm.init(function() {
      ...
      var updateTopTagsMatView = createCronJob(cronTimes.a, function() {
        ...
        orm.getModel('materialized_top_tags_view').query('REFRESH MATERIALIZED VIEW materialized_top_tags_view;', function(){ log.info('updateTopTagsMatView cron job ended'); });
      });
