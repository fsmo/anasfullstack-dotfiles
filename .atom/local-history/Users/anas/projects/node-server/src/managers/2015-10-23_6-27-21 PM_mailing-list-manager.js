...
exports.addUsersToMailingList=addUsersToMailingList;
...
function getGaveUpUsers() {
  return getUserModel()
    .find({
      registration_date: getPastDateTime(14)
    })
      ...
      return P.map(newUsers, function(newUser) {
          ...
          return getSongModel()
            ...
            .then(function(allUserSongs) {
              console.log(allUserSongs.length);
        ...
        .then(function(gaveUpUsers) {
          console.log('gaveUpUsers', gaveUpUsers);
          var filteredList = _.filter(gaveUpUsers, function(gaveUpUser) {
            return !!gaveUpUser;
          });
