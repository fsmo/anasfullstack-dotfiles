...
var UserFlagManager     = pRequire('/managers/user-flags-manager');
...
function getUserClient(requestHead){
  return UserFlagManager.getLoginFlagFromRequestHead(requestHead);
}
