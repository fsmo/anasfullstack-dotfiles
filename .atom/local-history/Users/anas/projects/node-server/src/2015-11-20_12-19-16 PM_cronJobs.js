...
(function initCron(handler) {
  ...
  loadCredentials(function(err, credentials) {
    ...
    orm.init(function() {
      ...
      var addNewUsersToRegistration = createCronJob(g,function() {
      ...
      var addUsersToMailingList = createCronJob(h,function() {
      ...
      var createProfileIndexes = createCronJob(i,function() {
      ...
      var createSongsIndexes = createCronJob(j,
      function() {
      ...
      var createSitemapsIndex = createCronJob(k,function() {
      ...
      var uploadSiteMaps = createCronJob(l,function() {
