...
(function initCron(handler) {
  ...
  loadCredentials(function(err, credentials) {
    ...
    orm.init(function() {
      ...
      var addNewUsersMainList = createCronJob(cronTimes.g, function() {
      ...
      var addNewUsersToStudioList = createCronJob(cronTimes.g, function() {
      ...
      var addNewUsersToOthersList = createCronJob(cronTimes.g, function() {
