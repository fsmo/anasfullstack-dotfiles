...
apiApp.get('/songs/search', cache('5 minutes'),
  function(req, res) {
...
apiApp.get('/songs/list/best', cache('10 hours'),
  function(req, res) {
    apiUtil.sendResponse(res,
      SongManager.getBestSongsList(req));
  });

apiApp.get('/songs/list/best-recent', cache('5 hours'),
  function(req, res) {
    apiUtil.sendResponse(res,
      SongManager.getRecentBestSongsList(req));
  });

apiApp.get('/recent-songs', auth.requireAdmin(),
  function(req, res) {
    apiUtil.sendResponse(res,
      SongManager.getRecentSongsList());
  });
