...
function mergeJson() {
  var mergedJsonDir = path.normalize(__dirname + '/../record-analysis/mergedJson.json');
  var mergedWavDir = path.normalize(__dirname + '/../record-analysis/mergedWav.wav');
  ...
  str(wavJsonData).unpipe(mergedJson);
