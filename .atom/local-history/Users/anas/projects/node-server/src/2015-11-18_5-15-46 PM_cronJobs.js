  ...
  loadCredentials(function(err, credentials) {
    ...
    orm.init(function() {
      ...
      var updateTopTagsMatView = createCronJob('00 15 04 * * *',function() {
        ...
        orm.getModel('materialized_top_tags_view').query('REFRESH MATERIALIZED VIEW materialized_song_view;',function(){
      ...
      var updateSongMatView = createCronJob('00 30 04 * * *',function() {
        ...
        orm.getModel('getTopTagsModel').query('REFRESH MATERIALIZED VIEW materialized_song_view;',function(){
