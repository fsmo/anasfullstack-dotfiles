...
(function initCron(handler) {
  ...
  loadCredentials(function(err, credentials) {
    ...
    orm.init(function() {
      ...
      var createProfileIndexes = createCronJob('00 00 00 * * *',function() {
      ...
      // cron job runs daily at 00:00
      var createSongsIndexes = createCronJob('00 00 00 * * *',function() {
        log.info('createSongsIndex Cron Job # 1 at 0:00 is now runnning!!');
